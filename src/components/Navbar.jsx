      ...
      <div className="flex flex-row space-x-4">
        {navigationItems.map((item, index) => (
          <NavLink
            ...
            to={item.route}
            className={() =>
              `text-base font-semibold text-black ${selected == item.route ? "text-red-500 underline" : "hover:text-red-500"} transition-all duration-200 ease-in-out max-sm:text-sm`
            }
